...
class WorkspaceData:
    def __init__(self):
        ...
        self.cursor.execute(
            "CREATE TABLE IF NOT EXISTS strategies (strategy_type TEXt, contract TEXT, timeframe TEXT, balance_pct "
            "REAL, take_profit REAL, stop_loss REAL, extra_params TEXT)")
        self.conn.commit()
